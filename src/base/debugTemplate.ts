...
<input hidden="hidden" id="switch" type="checkbox"  onchange="const custom = new Event('ce:pause');custom.value = this.checked;document.dispatchEvent(custom)"/>
<label id="switch-label" style="width: 60px;position:relative;height: 32px;text-align:center;line-height:32px;
text-shadow:1px 1px 8px #51b1dc;color:white;border-radius: 12px;background: #7a7ad3;box-shadow: inset -1px -1px 7px white,inset 1px 1px #666666" for="switch"></label>
